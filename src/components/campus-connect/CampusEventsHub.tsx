...
const SAMPLE_EVENTS: CampusEvent[] = [
  {
    ...
    description: "The biggest neon glow cultural gala on campus! Live DJ sets, food stalls, speed friending, and acoustic acoustic lounge.",
    attendees: [
  ...
  },
  {
    ...
    description: "Build groundbreaking AI applications in 10 hours. $5,000 in startup prizes, free catering, and mentor matching.",
    attendees: [
