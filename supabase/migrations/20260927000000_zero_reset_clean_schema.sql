-- ==============================================================================
-- UNICIRCLE PLATFORM: ZERO-RESET & MASTER FRESH SCHEMA INITIALIZATION
-- ==============================================================================
-- Run this in your Supabase SQL Editor:
-- https://supabase.com/dashboard/project/yztsnjnogiiblezrxqox/sql/new
--
-- This completely wipes all backend tables and data to ZERO,
-- and provisions a clean, unified schema with full Realtime and open RLS policies.
-- ==============================================================================
